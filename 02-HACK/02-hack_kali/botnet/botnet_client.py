    ...
    try:
        ...
        try:
            while True:
                ...
                # Se il messaggio Ã¨ "exit", chiude la connessione e termina
                ...
                # Invia il messaggio al server (in Python 2 non Ã¨ necessario codificare la stringa)
                ...
                while True:
                    ...
                    # Se non ci sono piÃ¹ dati, il server ha chiuso la connessione
                    if not data:
                    ...
                    # Se il messaggio ricevuto Ã¨ inferiore a 1024 byte, non ci sono altri dati in attesa
                    if len(data) < 1024:
                        break
        finally:
